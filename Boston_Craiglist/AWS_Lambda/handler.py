...
input_bucket = 'sdinputdata'
input_obj_path = 'neighborhood.txt'

output_bucket = 'sdoutputrentaldata'
ouput_obj_path = "rent_data_{}.json".format(date)



default_url = "https://boston.craigslist.org/search/apa?query={}&availabilityMode=0&sale_date=all+dates"
